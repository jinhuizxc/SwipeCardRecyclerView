package com.jinhui.swipecardrecyclerview.widget;
...
import com.jinhui.swipecardrecyclerview.SwipeCardAdapter;
...
public class SwipeCardRecyclerView extends RecyclerView {
    ...
    public SwipeCardRecyclerView(@NonNull Context context) {
        super(context);
//        this(context, null);
        initView();
    }

    public SwipeCardRecyclerView(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
//        this(context, attrs, 0);
        initView();
    }

    public SwipeCardRecyclerView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyle) {
